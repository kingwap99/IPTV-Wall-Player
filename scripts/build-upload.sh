...
REMOTE_CMD="export SCHEME='$SCHEME' DEST='$DEST' BUILD='$BUILD' DD='$DD' PROV='$PROV' PLATFORM='$PLATFORM' REMOTE_BASE='$REMOTE_BASE' REMOTE_ROOT='$REMOTE_ROOT' KEYCHAIN_PASSWORD='$KEYCHAIN_PASSWORD' ASC_USERNAME='$ASC_USERNAME'; "
